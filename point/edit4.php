...
<?php
$edit_record=@$_GET['e4'];
$query="select * from buy_property where u_id=$edit_record";
...
<head>
	...
	<title>UPDATING BUY PROPERTY DETAIL</title>
	<meta charset="utf-8">
...
<td height="70"  class="heading">
<input name="property_location1" style="margin-top:35px;width:300px;border-radius:5px;" value='<?php echo $property_location;?>'>
</td>
</tr>
<tr width="300">
<td height="70"  class="heading">
...
<input type="submit" name="update4" value="update"  style="width:90px;background-color:blue;color:white;border:none;margin-bottom:30px;">
</td>
</tr>
<?php 
}
...
if(isset($_POST['update4']))
{
	...
	$query1="update buy_property set username='$ed_username',email='$ed_email',name_of_property='$ed_name_of_property',property_location='$ed_property_location',mobile_no='$ed_mobile_no',property_cost='$ed_property_cost'
	where u_id=$edit_id";
