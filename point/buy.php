...
<!--=======content================================-->
<h1 align="center" style="font-weight:bold; font-family:LEHN086; color:rgb(143,57,90);font-size:50px;margin-top:60px;">BUY PROPERTY</h1>
...
<div id="image_background" style="width:300px;height:400px;background-color:white;margin-left:-280px;float:left;margin-top:-45px;border-radius:10px;">
	<div class="holder">
		<div id="image-1" class="image-lightbox">
			...
			<img src="images/rsz_1image20.jpg" alt="earth!">
			<a class="expand" href="#image-1"></a>
		</div>
	</div>
    <div><h1 align="center" style="margin-top:270px;">Paras House</h1></div>
	<div><h1 align="center" style="margin-top:5px;">Rs.50,00,000</h1></div>
	<div><h1 align="center"><a href="buydetail.php">Details</a></h1></div>
	<div><input type="submit" value="BUY NOW" name="book" style="background-color:red;border:none;width:90px;height:35px;margin-left:105px;border-radius:5px;" ></div>
	</div>
	...
	<div class="holder">
		<div id="image-2" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image24.jpg" alt="earth!">
			<a class="expand" href="#image-2"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Rochi House</h1></div>
	...
	<div class="holder">
		<div id="image-3" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image25.jpg" alt="earth!">
			<a class="expand" href="#image-3"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Anmol House</h1></div>
		<div><h1 align="center" style="margin-top:5px;">Rs.65,00,000</h1></div>
	<div><h1 align="center"><a href="buydetail.php">Details</a></h1></div>
	<div><input type="submit" value="BUY NOW" name="book" style="background-color:red;border:none;width:90px;height:35px;margin-left:105px;border-radius:5px;" ></div>
	</div>
	...
	<div class="holder">
		<div id="image-4" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image29.jpg" alt="earth!">
			<a class="expand" href="#image-4"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Raga House</h1></div>
		<div><h1 align="center" style="margin-top:5px;">Rs.60,00,000</h1></div>
	<div><h1 align="center"><a href="buydetail.php">Details</a></h1></div>
	<div><input type="submit" value="BUY NOW" name="book" style="background-color:red;border:none;width:90px;height:35px;margin-left:105px;border-radius:5px;" ></div>
	</div>
...
<div id="image_background" style="width:300px;height:400px;background-color:white;margin-left:-280px;float:left;margin-top:-45px;border-radius:10px;">
	<div class="holder">
		<div id="image-5" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image31.jpg" alt="earth!">
			<a class="expand" href="#image-5"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Santi Ghar</h1></div>
	...
	<div class="holder">
		<div id="image-6" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image32.jpg" alt="earth!">
			<a class="expand" href="#image-6"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Ghar Mera Ghar</h1></div>
		<div><h1 align="center" style="margin-top:5px;">Rs.65,00,000</h1></div>
	<div><h1 align="center"><a href="buydetail.php">Details</a></h1></div>
	<div><input type="submit" value="BUY NOW" name="book" style="background-color:red;border:none;width:90px;height:35px;margin-left:105px;border-radius:5px;" ></div>
	</div>
	...
	<div class="holder">
		<div id="image-7" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_1image35.jpg" alt="earth!">
			<a class="expand" href="#image-7"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Vanani House</h1></div>
	...
	<div class="holder">
		<div id="image-8" class="image-lightbox">
			<span class="close"><a href="buy.php">X</a></span>
			<img src="images/rsz_image42.jpg" alt="earth!">
			<a class="expand" href="#image-8"></a>
		</div>
	</div>
	<div><h1 align="center" style="margin-top:270px;">Uttam House</h1></div>
...
if(isset($_POST['book']))
{
	echo "<script>window.open('form_buy.php?booking=you can book now','_self')</script>";
	exit();
}?>
