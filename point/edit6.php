...
<?php
$edit_record=@$_GET['e6'];
$query="select * from property_on_rent where u_id=$edit_record";
...
<head>
	...
	<title>UPDATING RENT PROPERTY DETAIL</title>
	<meta charset="utf-8">
...
<input type="submit" name="update6" value="update" style="width:90px;background-color:blue;color:white;border:none;margin-bottom:30px;">
</td>
</tr>
<?php 
}
...
if(isset($_POST['update6']))
{
	...
	$query1="update property_on_rent set username='$ed_username',name_of_property='$ed_name_of_property',property_location='$ed_property_location',mobile_no='$ed_mobile_no',property_cost='$ed_property_cost'
	where u_id=$edit_id";
