...
<?php
$edit_record=@$_GET['e3'];
$query="select * from available_property_on_sell where name_of_property='$edit_record'";
...
<head>
	...
	<title>UPDATING AVAILABLE SELL PROPERTY DETAIL</title>
	<meta charset="utf-8">
...
<div class="body">
		<div class="container" style="width:100%;">
				...
				<nav class="cl-effect-10">
					<a href="#" data-hover="Update"><span>Update</span></a>
					<a href="#" data-hover="Available"><span>Available</span></a>
					<a href="#" data-hover="Sell"><span>Sell</span></a>
					<a href="#" data-hover="Property"><span>Property</span></a>
					<a href="#" data-hover="Detail"><span>Detail</span></a>
				</nav>
			</section>
...
<td height="70"  class="heading">
<input name="description1" value='<?php echo $description;?>' style="width:400px;">
</td>
</tr>
<tr  width="300">
<td height="70"  class="heading">
...
if(isset($_POST['update2']))
{
	...
	$query1="update available_property_on_sell set name_of_property='$ed_name_of_property',property_location='$ed_property_location',description='$ed_description',property_cost='$ed_property_cost'
